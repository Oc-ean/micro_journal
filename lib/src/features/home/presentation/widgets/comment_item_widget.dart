...
class _CommentItemWidgetState extends State<CommentItemWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final visibleReplies =
        _showReplies ? widget.replies : widget.replies.take(1).toList();
    final hiddenRepliesCount = widget.replies.length - 1;
    ...
    return Column(
      ...
      children: [
        ...
        if (hasReplies) ...[
          ...
          if (!_showReplies && hiddenRepliesCount > 0)
            Padding(
          ...
          if (_showReplies && widget.replies.length > 1)
            Padding(
              padding: const EdgeInsets.only(left: 44, bottom: 8),
              child: GestureDetector(
                onTap: () {
